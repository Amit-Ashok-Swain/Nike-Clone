...
export const Footer = () => {
    ...
    return (
        <Box h={'300px'} bg={'black'} color={'white'} mt={'40px'}>
            ...
            <Center h={'80px'}>
                <Text className="typeWritertheme">Made with <Icon as={FcLike} /> by Amit Ashok Swain </Text>
            </Center>
            ...
            >
                ...
                >
                    <IconLink
                        ...
                        link={"https://www.linkedin.com/in/amit-ashok-s-a510b9b9/"}
                    />
                    <IconLink
                        icon={FaGithub}
                        link={"https://github.com/ECommerce-Zone"}
                    />
                    <IconLink
                        icon={FaLinkedin}
                        link={"https://www.linkedin.com/in/amit-ashok-s-a510b9b9/"}
